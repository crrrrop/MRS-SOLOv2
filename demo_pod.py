...
def read_test_data(path_dir, _decode, test_dic):
...
if __name__ == '__main__':
    ...
    if not os.path.exists('images/masks/'): os.mkdir('images/masks/')
    if not os.path.exists('images/colored_masks/'): os.mkdir('images/colored_masks/')
    ...
    for k, filename in enumerate(path_dir):
        ...
        mask_save_path = 'images/masks/' + filename
        colored_mask_save_path = 'images/colored_masks/' + filename
        image, boxes, scores, classes = _decode.detect_image(image, pimage, ori_shape, resize_shape, draw_image, draw_thresh, save_mask=True, mask_save_path=mask_save_path, colored_mask_save_path=colored_mask_save_path)
